...
let clients = [
    new Client(4, 'ketchup', 'pomidor', '12312e2asd@gmail.com', '+3806666766666', new Product('suhariki', 20), new Product('cola', 50), new Product('cola', 50)),
    ...
    new Client(7, '83i9h', '3rt7g8', '1231@gmail.com', '+3806666736666', new Product('suhariki', 20)),
    new Client(5, '2390ryh', 'y908h', '123@gmail.com', '+3806666766566', new Product('suhariki', 20), new Product('cola', 50),  new Product('cola', 50),  new Product('cola', 50)),
