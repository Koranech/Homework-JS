...
Array.prototype.foreach = function(callback){
    ...
    for (const item of arr) {
        callback(item)
        //Тут помилки немає.
        // Майже завжди нам потрібний лише сам елемент.
        // Але якщо ви пишете свій myForEach і не передаєте index і arr,
        // то інший розробник може спробувати використовувати індекс,
        // і його код зламається, тому що вашу функцію прийде тільки перший параметр.
        // Тому тут треба враховувати нюанси
    }
}
